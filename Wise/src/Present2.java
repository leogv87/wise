...
public class Present2 extends JFrame {
	...
	public Present2() {
		...
		final Present3 window9 = new Present3();
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dispose();
				Present1 window7=new Present1();
				window7.setVisible(true);
			}
		});
		button.setBounds(158, 614, 300, 40);
		...
		btnMenu.setBounds(500, 614, 300, 40);
		...
		btnNext.setBounds(852, 614, 300, 40);
		contentPane.add(btnNext);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\LEONARDO\\Pictures\\WISE\\Present2.png"));
